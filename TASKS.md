...
| 19 | Implement 5 real adapters (balance, transaction history, accounts, device history, login history) forwarding JWT to platform endpoints [E-03/F-05], T-19 (added 2026-09-01) — NOTE (found during T-09, 2026-09-01): only transaction_history exists as a real taxonomy id; balance/accounts/device_history/login_history are direct account features, not services in support/v1/services or pay-transfer — this task needs a classification path for those 4 outside the taxonomy-driven tool schema (e.g. fixed extra tools alongside the taxonomy-sourced ones in T-12), not just adapter implementations | Establish foundation for future change | Planning 2026-09-01 | 🔴 | — | ⏳ TODO | banking-service-integration | — | — |
