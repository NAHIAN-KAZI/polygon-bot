...
| 20 | Implement real HS256 JWT verification replacing ADR-0008 fail-closed stub, incl. correct exp handling [ADR-0008 amendment], T-20 (added 2026-09-03) — live test login against bank dev environment confirmed HS256 (not RS256; api-endpoints-guide.md's Kong HS256 note was right), sub=phone number, iss="internet-banking", 15-min exp. Blocked from ✅ DONE until bank provides the real JWT_HS256_SECRET for live verification gate | Establish foundation for future change | User 2026-09-03 | 🔴 | — | 🔄 IN_PROGRESS | customer-identity-session | 2026-09-03 | — |
